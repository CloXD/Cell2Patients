...
def main():
    ...
    c2p = Cell2Patients(clf=clf, clf_transfer= clf_t,max_run=max_run,threshold=parameters.threshold,increment_rate=parameters.increment_rate, out_dir="{}/transfer/".format(pathOutput), verbose=verbose, scale=parameters.scale)
